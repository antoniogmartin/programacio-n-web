	...
	if($auth_usuario->is_loggedin()!="")//si no esta logueado
	{
		...
		if(isset($_POST['enviar']))
		{
		  ...
		  $chora = date('H:i:s',time());
			...
			$auth_usuario->redirect("cali_el_dandee_juan_magan_por_fin_te_encontre_20150925.php");//tiene el objetivo de desactivar el POST_enviar al recargar
		}
	}
?>
...
function validacion() {
	...
	miVentana.document.write("<p>Por fin te encontré</p>");
...
<html lang="es">
							                ...
							                <thead>
							                    ...
							                    <tr>
							                        ...
							                        <td class="secciones"style="background-color: lightgreen">
							                             <a href="../reggaeton.php" >REGGAETON</a>
							                        </td>
	...
	<aside>
				...
				<section class="disco_ampliado">
					<h1>Por fin te encontr&eacute</h1>

					</section>

				<section class="album">
					<h2>Juan Magan, Cali y el Dandee</h2>
						<table class="info_disco">
							<tbody>
								<tr>
										<td><img src="cali_el_dandee_juan_magan_por_fin_te_encontre_20150925.jpeg" onMouseOver="show_list_album()" onclick="hide_list_album()"></td>
								</tr>
								<tr>
									<td>
										<table class="datos_disco">
											<tbody>
											<tr><td><p>Genero:Reggaeton</p></td></tr>
											<tr><td><p>Precio: 0,99€</p></td></tr>
											<tr><td><p>Producido: Universal Music</p></td></tr>
						...
						<table class="pista">
								<tbody>
									<tr>
										<td>
											<input type="radio" id="pista1" name="pista_por_fin" value="pista1" checked>
										</td>

										<td>
											<label for "pista1"> Por fin te encontr&eacute </label>
										</td>
									</tr>
								</tbody>
							</table>
							<section class="opciones_disco">
								...
								if($auth_usuario->is_loggedin()!=""){echo $new_comment->countComments("reggaeton");}
								else{
									echo "15";
								}
							...
							<?php
								$resConsulta=$new_comment->showComments("reggaeton");
