	...
	if($auth_usuario->is_loggedin()!="")//si no esta logueado
	{
		...
		if(isset($_POST['enviar']))
		{
		  ...
		  $chora = date('H:i:s',time());
			...
			$auth_usuario->redirect("armin_van_buuren_embrace_20151029.php");//tiene el objetivo de desactivar el POST_enviar al recargar
		}
	}
...
function validacion() {//FALLO, METE COMENTARIOS AL RECARGAR
	var valor;
	var msg="";
	var res=true;
	...
	miVentana.document.write("<p>Embrace</p>");
	miVentana.document.write("<p>Another you</p>");
	miVentana.document.write("<p>Strong ones</p>");
	miVentana.document.write("<p>Make it right</p>");
	miVentana.document.write("<p>Face of summer</p>");
	miVentana.document.write("<p>Hands to heaven</p>");
				...
				<section class="album">
					<h2>Armin Van Buuren</h2>
						<table class="info_disco">
							<tbody>
								<tr>
										<td><img src="./armin_van_buuren_embrace_20151029.jpg" onMouseOver="show_list_album()" onclick="hide_list_album()"></td>
								</tr>
								<tr>
									<td>
										<table class="datos_disco">
											...
											<tr><td><p>Genero:Edm</p></td></tr>
											<tr><td><p>Precio: 11,99€</p></td></tr>
											<tr><td><p>Producido: Armin Audio</p></td></tr>
						...
						<table class="pista">
								<tbody>
									<tr>
										<td>
											<input type="radio" id="pista1" name="pista_embrace" value="pista1" checked>
										</td>
										<td>
											<label for "pista1"> Embrace </label>
										</td>
									</tr>
									<tr>
										<td>
											<input type="radio" id="pista2" name="pista_embrace" value="pista2" >
										</td>
										<td>
											<label for "pista2"> Another you </label>
										</td>
									</tr>
									<tr>
										<td>
											<input type="radio" id="pista3" name="pista_embrace" value="pista3">
										</td>
										<td>
											<label for "pista3">Strong ones</label>
										</td>
									</tr>
									<tr>
										<td>
											<input type="radio" id="pista4" name="pista_embrace" value="pista4">
										</td>
										<td>
											<label for "pista4"> Make it right</label>
										</td>
									</tr>
									<tr>
										<td>
											<input type="radio" id="pista5" name="pista_embrace" value="pista5">
										</td>
										<td>
											<label for "pista5"> Face of summer </label>
										</td>
									</tr>
									<tr>
										<td>
											<input type="radio" id="pista6" name="pista_embrace" value="pista6">
										</td>
										<td>
											<label for "pista6"> Hands to heaven</label>
										</td>
									</tr>
								</tbody>
							</table>
							<section class="opciones_disco">
								...
								if($auth_usuario->is_loggedin()!=""){echo $new_comment->countComments("edm");}
								else{
									echo "15";
								}
							...
							<?php
								$resConsulta=$new_comment->showComments("edm");
